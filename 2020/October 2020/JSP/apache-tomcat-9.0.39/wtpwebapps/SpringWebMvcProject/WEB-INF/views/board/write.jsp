      ...
      <div class="card-body">
        ...
        <form role="form" method="post">
          ...
          <div class="form-group" hidden="hidden">
            <label>작성자</label>
            <input type="text" class="form-control" name='writer' placeholder="이름을 입력" value="${login.name}">
          </div>
          
          <div class="form-group">
            <label>제목</label>
            <input type="text" class="form-control" name='title' placeholder="제목을 입력">
          </div>

          <div class="form-group">
            <label>내용</label>
            <textarea class="form-control" rows="5" name='content' placeholder="내용이 뭔가"></textarea>
          </div>
